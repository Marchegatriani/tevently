...
<body class="bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 min-h-screen flex items-center justify-center p-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            autofocus 
                            autocomplete="name"
                            class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition @error('name') border-red-500 @enderror"
    ...
    <script>
        function togglePassword(fieldId) {
            ...
            const eyeOpen = document.getElementById('eye-open-' + fieldId.replace('_', '-'));
            const eyeClosed = document.getElementById('eye-closed-' + fieldId.replace('_', '-'));
