            ...
            <div class="max-w-7xl mx-auto px-4 py-2">
                <nav class="flex flex-col gap-1 text-sm text-custom-dark">
                    ...
                    <div class="mt-2 pt-2 border-t">
                        ...
                        <a href="{{ route('register') }}" class="block mx-3 my-2 bg-[#837ab6] hover:bg-[#9d85b6] text-white px-4 py-2 rounded-xl text-center font-bold shadow-md">
                            Daftar
                        </a>
                    </div>
                </nav>
    ...
    <footer class="bg-white text-custom-dark py-12 mt-20 border-t border-[#f7c2ca]"> 
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <!-- Categories (HARDCODED FIX) -->
                <div>
                    <h3 class="text-lg font-bold mb-5 text-custom-dark">Kategori</h3>
                ...
                <div>
                    <h3 class="text-lg font-bold mb-5 text-custom-dark">Kontak</h3>
                    <ul class="space-y-3 text-sm text-gray-600">
                    ...
                    <!-- Social Media -->
                    <div class="flex gap-4 mt-6 text-gray-600">
                        <a href="#" class="bg-gray-200 hover:bg-[#837ab6] p-2 rounded-full transition hover:text-white">
            ...
            <!-- Copyright -->
            <div class="border-t border-[#f7c2ca] mt-8 pt-8 text-center text-gray-400">
