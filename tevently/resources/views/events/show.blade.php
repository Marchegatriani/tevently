    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                <a href="{{ Auth::user()->role === 'admin' ? route('admin.events.edit', $event) : route('organizer.events.edit', $event) }}" class="bg-yellow-500 text-white px-4 py-2 rounded-md hover:bg-yellow-600">
                    Edit
                </a>
                <a href="{{ Auth::user()->role === 'admin' ? route('admin.events.index') : route('organizer.events.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600">
                    Back
                </a>
            </div>
        </div>
