                ...
                <div class="bg-white rounded-3xl shadow-xl p-8 sticky top-6 border border-gray-100">
                    ...
                    <form method="GET" action="{{ route('guest.events.index') }}">
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <a href="{{ route('guest.events.index') }}" class="w-full text-center bg-gray-200 hover:bg-gray-300 text-custom-dark px-4 py-3 rounded-xl font-semibold transition">
                                Hapus Semua
                            </a>
                        </div>
                    </form>
            ...
            <div class="flex-1">
                ...
                @if($events->count() > 0)
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        @foreach($events as $event)
                            <a href="{{ route('guest.events.show', $event) }}" class="group bg-white rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl hover:shadow-[#cc8db3]/40 hover:-translate-y-1 transition-all duration-300 border border-gray-100">
                                <!-- Image/Placeholder -->
                ...
                @else
                    ...
                    <div class="bg-white rounded-3xl shadow-lg p-12 text-center border border-gray-100">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('guest.events.index') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-xl text-white bg-[#837ab6] hover:bg-[#9d85b6] transition">
                                Hapus Filter
                            </a>
                        </div>
                    </div>
