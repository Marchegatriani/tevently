                    ...
                    <form method="POST" action="{{ route('organizer.events.update', $event) }}" enctype="multipart/form-data">
                        ...
                        @if($event->image_url)
                            <div class="mb-6">
                                ...
                                <img src="{{ asset('storage/' . $event->image_url) }}" alt="{{ $event->title }}" class="h-48 w-auto rounded-lg border">
                            </div>
                        @endif
                        ...
                        <div class="flex items-center justify-end gap-4">
                            ...
                            <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-md font-semibold">
                                Update Event
                            </button>
                        </div>
                    </form>
