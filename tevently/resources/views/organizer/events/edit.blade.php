@extends('lorganizer.partials.navbar')
                ...
                <div class="bg-white shadow-sm rounded-lg">
                    <form action="{{ route('organizer.events.update', $event) }}" method="POST" enctype="multipart/form-data" class="p-6">
                        ...
                        <div class="flex gap-4">
                            ...
                            <a href="{{ route('organizer.events.show', $event) }}" class="bg-gray-300 text-gray-700 px-6 py-2 rounded hover:bg-gray-400 transition">
                                Cancel
                            </a>
                        </div>
                    </form>
                                ...
                                <div class="border rounded-lg p-4 {{ $ticket->is_active ? 'border-gray-200' : 'border-red-200 bg-red-50' }}">
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        @if($ticket->quantity_sold == 0)
                                            <form action="{{ route('organizer.tickets.destroy', [$event, $ticket]) }}" 
                                                  method="POST" 
