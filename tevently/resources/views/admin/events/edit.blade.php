...
@section('subheading', 'Perbarui informasi event dan kelola tiket')
                ...
                <div class="bg-white shadow-xl rounded-2xl p-8 border border-gray-100">
                    <form action="{{ route('admin.events.update', $event) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="flex gap-4 pt-4 border-t border-gray-100 mt-6">
                            ...
                            <a href="{{ route('admin.events.index') }}" class="bg-gray-300 text-custom-dark px-6 py-3 rounded-xl font-bold hover:bg-gray-400 transition duration-300 transform hover:-translate-y-0.5">
                                Batal
                            </a>
                        </div>
                    </form>
                ...
                <div class="bg-white shadow-xl rounded-2xl p-6 border border-gray-100 sticky top-4">
                                    ...
                                    <div class="flex gap-2 text-sm font-semibold">
                                        ...
                                        @if($ticket->quantity_sold == 0)
                                            <form action="{{ route('admin.tickets.destroy', [$event, $ticket]) }}" 
                                                ...
                                                @method('DELETE')
                                                <button type="submit" 
                                                        class="bg-red-600 text-white p-2 rounded-xl hover:bg-red-700 transition shadow-md">
                    ...
                    @else
                        <div class="text-center py-8 bg-gray-50 rounded-xl border border-gray-100">
                            <p class="text-gray-600 mb-4">Event ini belum memiliki tiket.</p>
                            <a href="{{ route('admin.tickets.create', $event) }}" 
