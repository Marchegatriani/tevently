        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    ...
                    <p class="text-gray-600">You have full access to manage the system as an administrator.</p>
                </div>
            </div>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <a href="#" class="flex items-center p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition">
                            ...
                            <div class="ml-4">
                                    <!-- Manage Users -->
        <a href="{{ route('admin.users.index') }}" class="flex items-center p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition">
            <div class="flex-shrink-0 bg-indigo-500 rounded-md p-3">
                <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
                ...
                <p class="text-xs text-gray-600">View and manage all users</p>
                        ...
                        <a href="#" class="flex items-center p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-xs text-gray-600">View and manage all events</p>
                            </div>
                        </a>
                        ...
                        <a href="#" class="flex items-center p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-xs text-gray-600">Sales and statistics reports</p>
                            </div>
                        </a>
                        ...
                        <a href="#" class="flex items-center p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-xs text-gray-600">System configuration</p>
                            </div>
                        </a>
                    </div>
                </div>
